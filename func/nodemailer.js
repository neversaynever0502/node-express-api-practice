...
function sendMail(mailList,password){
    let mailOptions = {
        ...
        html: '<a href="https://intheblackworld.github.io/reactWithNodejsAPITest/#/confirm?email='+mailList+'&password='+password+'">confirm member</a><b>Nothing But Handsome Guy</b><br><img src="http://i.imgur.com/kqAIaDx.jpg"></img>' // html body
    };
